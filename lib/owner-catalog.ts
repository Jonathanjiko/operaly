...
const DEFAULT_ADDONS: OwnerCatalogAddon[] = [
  {
    ...
    price: 10,
    currency: "PEN",
    billingPeriodLabel: "vigencia 1 mes",
    category: "voz",
    features: ["Audio y llamadas", "Se vence en 1 mes", "No acumulable"],
    extra_messages: 0,
    extra_minutes: 5,
    extra_storage_gb: 0,
    extra_automations: 0,
  ...
  },
  {
    ...
    billingPeriodLabel: "vigencia 1 mes",
    category: "voz",
    features: ["Mas aire para llamadas", "Se vence en 1 mes", "No acumulable"],
    extra_messages: 0,
    extra_minutes: 10,
    extra_storage_gb: 0,
    extra_automations: 0,
  ...
  },
  {
    ...
    description: "+1 GB mensual para archivos y baul secreto.",
    price: 7.5,
    currency: "PEN",
    billingPeriodLabel: "mensual adicional",
    category: "storage",
    features: ["Archivos y baul", "Se suma al plan mensual"],
    extra_messages: 0,
    extra_minutes: 0,
    extra_storage_gb: 1,
    extra_automations: 0,
  ...
  },
  {
    ...
    description: "+3 GB mensuales para archivos y baul secreto.",
    price: 20,
    currency: "PEN",
    billingPeriodLabel: "mensual adicional",
    category: "storage",
    features: ["Mas capacidad documental", "Se suma al plan mensual"],
    extra_messages: 0,
    extra_minutes: 0,
    extra_storage_gb: 3,
    extra_automations: 0,
  ...
  },
  {
    ...
    billingPeriodLabel: "vigencia 1 mes",
    category: "ia",
    features: ["Refuerzo de consumo", "Se vence en 1 mes", "No acumulable"],
    extra_messages: 500,
    extra_minutes: 0,
    extra_storage_gb: 0,
    extra_automations: 0,
