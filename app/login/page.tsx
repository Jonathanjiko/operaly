        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-10">
            ...
            <p className="text-muted-foreground">
              Ingresa a tu cuenta para continuar con Operaly.
            </p>
          </div>
          ...
          <div className="space-y-3 mb-8">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-border bg-card hover:bg-secondary/50 transition-colors"
            >
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-[#0F1F63] via-[#1a2d7c] to-[#0F1F63] relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">
            Tu asistente de IA para WhatsApp
          </h2>
          <p className="text-white/70 text-lg max-w-md">
            Automatiza la atención al cliente, gestiona tu agenda y organiza tu negocio desde WhatsApp.
          </p>
        </div>
      </div>
    </div>
