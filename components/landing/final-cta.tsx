...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      ...
      <div className="absolute bottom-0 right-0 h-full w-full bg-[radial-gradient(ellipse_at_bottom_right,rgba(6,182,212,0.20),transparent_50%)]" />
      ...
      <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-10 inline-flex items-center gap-2 rounded-full border border-[#3B82F6]/30 bg-[#3B82F6]/10 px-5 py-2.5">
          <span className="h-2 w-2 animate-pulse rounded-full bg-[#34D399]" />
          <p className="text-sm font-medium text-[#BFDBFE]">
            Pruebe el audio, la agenda y el dashboard en una sola experiencia.
          </p>
        </div>
      </div>
    </section>
